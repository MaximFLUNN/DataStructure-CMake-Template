...
int main() {
	...
	/*std::string exp = "cos(sin(cos(1*2/3+2^3-sin(cos(6^2+5!*20)))))";
	const char* exp2 = "cos(sin(cos(1*2/3+2^3-sin(cos(6^2+5!*20)))))";*/
	std::string exp = "123+5-(4*123/5*(123+123+(1))/123)-2^10";
	const char* exp2 = "123+5-(4*123/5*(123+123+(1))/123)-2^10";
	std::cout << "\n ===================== \n";
	...
	end_time = clock();
	std::cout << "\n" << end_time - start_time << "ms | tinyexpr";
	//system("pause");
	return 0;
}
